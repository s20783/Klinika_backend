...
namespace Test.Mock
{
    public class MedicamentMockTests
    {
        ...
        public async Task CreateLekShouldBeCorrectTest()
        {
            ...
            var command = new CreateMedicamentCommand()
            {
                request = new MedicamentRequest
                {
                    Nazwa = "aaa",
                    JednostkaMiary = "ml",
                    Producent = "..."
        ...
        public async Task UpdateLekShouldBeCorrectTest()
        {
            ...
            var command = new UpdateMedicamentCommand()
            {
        ...
        public async Task DeleteLekShouldBeCorrectTest()
        {
            ...
            var command = new DeleteMedicamentCommand()
            {
                ID_lek = hash.Encode(1)
            };
