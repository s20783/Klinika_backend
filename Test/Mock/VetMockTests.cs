...
namespace Test.Mock
{
    public class VetMockTests
    {
        ...
        public void SetUp()
        {
            ...
            harmonogramService = new ScheduleService(new MockEmailSender());
        ...
        {
            var handler = new UpdateWeterynarzCommandHandler(mockContext.Object, hash, new MemoryMockCache<GetVetListResponse>());

            UpdateVetCommand command = new UpdateVetCommand()
            {
                ID_osoba = hash.Encode(2),
                request = new Application.DTO.VetUpdateRequest
                {
                    Imie = "aaaa",
                    Nazwisko = "bbbb",
        ...
        {
            var handler = new DeleteWeterynarzCommandHandler(mockContext.Object, hash, new MemoryMockCache<GetVetListResponse>(), harmonogramService);

            DeleteVetCommand command = new DeleteVetCommand()
            {
                ID_osoba = hash.Encode(2)
            };
