...
namespace Test.Mock
{
    public class VisitDiseaseMockTests
    {
        ...
        public async Task AddWizytaChorobaShouldBeCorrectTest()
        {
            ...
            AddVisitDiseaseCommand command = new AddVisitDiseaseCommand()
            {
        ...
        public async Task RemoveWizytaChorobaShouldBeCorrectTest()
        {
            ...
            RemoveVisitDiseaseCommand command = new RemoveVisitDiseaseCommand()
            {
                ID_choroba = hash.Encode(1),
                ID_wizyta = hash.Encode(1)
            };
