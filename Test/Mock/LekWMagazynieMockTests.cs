...
namespace Test.Mock
{
    public class LekWMagazynieMockTests
    {
        ...
        public async Task CreateStanLekuShouldBeCorrectTest()
        {
            ...
            var command = new CreateStanLekuCommand()
            {
                ID_lek = hash.Encode(1),
                request = new Application.DTO.Request.StanLekuRequest
                {
                    Ilosc = 10,
        ...
        public async Task UpdateStanLekuShouldBeCorrectTest()
        {
            ...
            var command = new UpdateStanLekuCommand()
            {
        ...
        public async Task DeleteStanLekuShouldBeCorrectTest()
        {
            ...
            var command = new DeleteStanLekuCommand()
            {
                ID_stan_leku = hash.Encode(1)
            };
