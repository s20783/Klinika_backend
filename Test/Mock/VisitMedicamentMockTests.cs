...
namespace Test.Mock
{
    public class VisitMedicamentMockTests
    {
        ...
        public async Task AddWizytaLekShouldBeCorrectTest()
        {
            ...
            AddVisitMedicamentCommand command = new AddVisitMedicamentCommand()
            {
        ...
        public async Task RemoveWizytaLekShouldBeCorrectTest()
        {
            ...
            RemoveVisitMedicamentCommand command = new RemoveVisitMedicamentCommand()
            {
