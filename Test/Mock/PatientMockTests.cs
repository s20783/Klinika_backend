...
namespace Test.Mock
{
    public class PatientMockTests
    {
        ...
        {
            var handler = new CreatePacjentCommandHandle(mockContext.Object, hash, new MemoryMockCache<GetPatientListResponse>());

            CreatePatientCommand command = new CreatePatientCommand()
            {
                request = new Application.DTO.Request.PatientRequest
                {
        ...
        {
            var handler = new UpdatePacjentCommandHandle(mockContext.Object, hash, new MemoryMockCache<GetPatientListResponse>());
        ...
        public async Task DeletePacjentShouldBeCorrectTest()
        {
            ...
            var handler = new DeletePacjentCommandHandle(mockContext.Object, hash, new MemoryMockCache<GetPatientListResponse>());

            DeletePatientCommand command = new DeletePatientCommand()
            {
                ID_Pacjent = hash.Encode(1)
            };
