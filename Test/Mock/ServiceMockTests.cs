...
namespace Test.Mock
{
    public class ServiceMockTests
    {
        ...
        public async Task CreateUslugaShouldBeCorrectTest()
        {
            ...
            var handler = new CreateUslugaCommandHandler(mockContext.Object, new MemoryMockCache<GetServiceResponse>());
        ...
        {
            var handler = new UpdateUslugaCommandHandler(mockContext.Object, hash, new MemoryMockCache<GetServiceResponse>());
        ...
        {
            var before = mockContext.Object.Uslugas.Count();
            var handler = new DeleteUslugaCommandHandler(mockContext.Object, hash, new MemoryMockCache<GetServiceResponse>());
