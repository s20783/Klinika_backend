...
namespace Test.Mock
{
    public class SpecializationMockTests
    {
        ...
        public async Task CreateSpecjalizacjaShouldBeCorrectTest()
        {
            ...
            var handler = new CreateSpecjalizacjaCommandHandler(mockContext.Object, hash, new MemoryMockCache<GetSpecializationResponse>());
        ...
        {
            var handler = new UpdateSpecjalizacjaCommandHandler(mockContext.Object, hash, new MemoryMockCache<GetSpecializationResponse>());
        ...
        {
            var before = mockContext.Object.Specjalizacjas.Count();
            var handler = new DeleteSpecjalizacjaCommandHandler(mockContext.Object, hash, new MemoryMockCache<GetSpecializationResponse>());
