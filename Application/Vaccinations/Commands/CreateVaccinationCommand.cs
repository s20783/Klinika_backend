...
namespace Application.Szczepienia.Commands
{
    ...
    public class CreateSzczepienieCommandHandler : IRequestHandler<CreateVaccinationCommand, int>
    {
        ...
        public async Task<int> Handle(CreateVaccinationCommand req, CancellationToken cancellationToken)
        {
