...
{
    public class AddVetSpecializationCommand : IRequest<int>
    {
        public string ID_specjalizacja { get; set; }
        public string ID_weterynarz { get; set; }
    }

    public class AddSpecjalizacjaWeterynarzCommandHandler : IRequestHandler<AddVetSpecializationCommand, int>
    {
        ...
        public async Task<int> Handle(AddVetSpecializationCommand req, CancellationToken cancellationToken)
        {
