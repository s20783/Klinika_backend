...
namespace Application.Wizyty.Queries
{
    ...
    public class WizytaAdminQueryHandle : IRequestHandler<WizytaAdminQuery, List<GetWizytaListResponse>>
    {
        private readonly IKlinikaContext context;
        private readonly IHash hash;
        public WizytaAdminQueryHandle(IKlinikaContext klinikaContext, IHash _hash)
        {
