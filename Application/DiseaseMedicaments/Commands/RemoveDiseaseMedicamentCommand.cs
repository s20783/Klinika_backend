...
{
    public class RemoveDiseaseMedicamentCommand : IRequest<int>
    {
        public string ID_lek { get; set; }
        public string ID_choroba { get; set; }
    }

    public class RemoveChorobaLekCommandHandler : IRequestHandler<RemoveDiseaseMedicamentCommand, int>
    {
        ...
        public async Task<int> Handle(RemoveDiseaseMedicamentCommand req, CancellationToken cancellationToken)
        {
