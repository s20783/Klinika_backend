...
{
    public class AcceptVisitServicesCommand : IRequest<int>
    {
        public string ID_wizyta { get; set; }
    }

    public class AcceptWizytaUslugaCommandHandler : IRequestHandler<AcceptVisitServicesCommand, int>
    {
        ...
        public async Task<int> Handle(AcceptVisitServicesCommand req, CancellationToken cancellationToken)
        {
            ...
            wizyta.Status = VisitStatus.Zrealizowana.ToString();
