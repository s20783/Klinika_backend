...
{
    public class ScheduleAdminByIDQuery : IRequest<object>
    {
        public string ID_osoba { get; set; }
        public DateTime Date { get; set; }
    }

    public class HarmonogramAdminByIDQueryHandler : IRequestHandler<ScheduleAdminByIDQuery, object>
    {
        ...
        public async Task<object> Handle(ScheduleAdminByIDQuery req, CancellationToken cancellationToken)
        {
