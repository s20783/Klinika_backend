...
{
    public class ScheduleAdminQuery : IRequest<object>
    {
        public DateTime Date { get; set; }
    }

    public class HarmonogramAdminQueryHandle : IRequestHandler<ScheduleAdminQuery, object>
    {
        ...
        public async Task<object> Handle(ScheduleAdminQuery req, CancellationToken cancellationToken)
        {
