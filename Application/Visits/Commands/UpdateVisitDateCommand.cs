...
{
    public class UpdateVisitDateCommand : IRequest<int>
    {
    ...
    public class PrzelozWizyteCommandHandler : IRequestHandler<UpdateVisitDateCommand, int>
    {
        private readonly IKlinikaContext _context;
        private readonly IHash _hash;
        private readonly IVisit _wizytaRepository;
        public PrzelozWizyteCommandHandler(IKlinikaContext klinikaContext, IHash hash, IVisit wizyta)
        {
        ...
        public async Task<int> Handle(UpdateVisitDateCommand req, CancellationToken cancellationToken)
        {
            ...
            if (!wizyta.Status.Equals(VisitStatus.Zaplanowana.ToString()))
            {
                throw new Exception();
            }
            ...
            (DateTime rozpoczecie, DateTime zakonczenie) = _wizytaRepository.GetVisitDates(oldHarmonograms);
