...
{
    public class VisitClientQuery : IRequest<List<GetVisitListResponse>>
    {
        public string ID_klient { get; set; }
    }

    public class WizytaKlientQueryHandle : IRequestHandler<VisitClientQuery, List<GetVisitListResponse>>
    {
        ...
        public async Task<List<GetVisitListResponse>> Handle(VisitClientQuery req, CancellationToken cancellationToken)
        {
