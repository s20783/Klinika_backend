...
{
    public class VisitDetailsAdminQuery : IRequest<GetVisitDetailsAdminResponse>
    {
        public string ID_wizyta { get; set; }
    }

    public class WizytaDetailsAdminQueryHandle : IRequestHandler<VisitDetailsAdminQuery, GetVisitDetailsAdminResponse>
    {
        private readonly IKlinikaContext _context;
        private readonly IHash _hash;
        private readonly IVisit _wizyta;
        public WizytaDetailsAdminQueryHandle(IKlinikaContext klinikaContext, IHash hash, IVisit wizyta)
        {
        ...
        public async Task<GetVisitDetailsAdminResponse> Handle(VisitDetailsAdminQuery req, CancellationToken cancellationToken)
        {
            ...
            if (harmonograms.Any())
            {
                ...
                return (from x in _context.Wizyta
                        ...
                        where x.IdWizyta == id
                        select new GetVisitDetailsAdminResponse()
                        {
                            Status = x.Status,
