...
{
    public class VisitAdminQuery : IRequest<List<GetVisitListResponse>>
    {
        public string ID_klient { get; set; }
    }

    public class WizytaAdminQueryHandler : IRequestHandler<VisitAdminQuery, List<GetVisitListResponse>>
    {
        ...
        public async Task<List<GetVisitListResponse>> Handle(VisitAdminQuery req, CancellationToken cancellationToken)
        {
