...
{
    public class VisitDetailsClientQuery : IRequest<GetVisitDetailsClientResponse>
    {
        public string ID_wizyta { get; set; }
        public string ID_klient { get; set; }
    }

    public class WizytaDetailsKlientQueryHandle : IRequestHandler<VisitDetailsClientQuery, GetVisitDetailsClientResponse>
    {
        private readonly IKlinikaContext _context;
        private readonly IHash _hash;
        private readonly IVisit _wizyta;
        public WizytaDetailsKlientQueryHandle(IKlinikaContext klinikaContext, IHash hash, IVisit wizyta)
        {
        ...
        public async Task<GetVisitDetailsClientResponse> Handle(VisitDetailsClientQuery req, CancellationToken cancellationToken)
        {
            ...
            if (harmonograms.Any())
            {
                ...
                return (from x in _context.Wizyta
                        ...
                        select new GetVisitDetailsClientResponse()
                        {
                            Status = x.Status,
