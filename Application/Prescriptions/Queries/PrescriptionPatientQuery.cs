...
{
    public class PrescriptionPatientQuery : IRequest<List<GetPrescriptionResponse>>
    {
        public string ID_pacjent { get; set; }
    }

    public class ReceptaPacjentQueryHandler : IRequestHandler<PrescriptionPatientQuery, List<GetPrescriptionResponse>>
    {
        ...
        public async Task<List<GetPrescriptionResponse>> Handle(PrescriptionPatientQuery req, CancellationToken cancellationToken)
        {
