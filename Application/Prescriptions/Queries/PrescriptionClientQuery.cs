...
{
    public class PrescriptionClientQuery : IRequest<List<GetPrescriptionResponse>>
    {
        public string ID_klient { get; set; }
    }

    public class ReceptaKlientQueryHandler : IRequestHandler<PrescriptionClientQuery, List<GetPrescriptionResponse>>
    {
        ...
        public async Task<List<GetPrescriptionResponse>> Handle(PrescriptionClientQuery req, CancellationToken cancellationToken)
        {
