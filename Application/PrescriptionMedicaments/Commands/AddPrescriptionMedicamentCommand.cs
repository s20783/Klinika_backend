...
{
    public class AddPrescriptionMedicamentCommand : IRequest<int>
    {
    ...
    public class CreateReceptaLekCommandHandler : IRequestHandler<AddPrescriptionMedicamentCommand, int>
    {
        ...
        public async Task<int> Handle(AddPrescriptionMedicamentCommand req, CancellationToken cancellationToken)
        {
