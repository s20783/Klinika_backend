...
{
    public class RemoveVisitDiseaseCommand : IRequest<int>
    {
        public string ID_wizyta { get; set; }
        public string ID_choroba { get; set; }
    }

    public class RemoveWizytaChorobaCommandHandler : IRequestHandler<RemoveVisitDiseaseCommand, int>
    {
        ...
        public async Task<int> Handle(RemoveVisitDiseaseCommand req, CancellationToken cancellationToken)
        {
