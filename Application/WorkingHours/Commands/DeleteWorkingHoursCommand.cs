...
{
    public class DeleteWorkingHoursCommand : IRequest<int>
    {
        public string ID_osoba { get; set; }
        public int Day { get; set; }
    }

    public class DeleteGodzinyPracyCommandHandle : IRequestHandler<DeleteWorkingHoursCommand, int>
    {
        ...
        public async Task<int> Handle(DeleteWorkingHoursCommand req, CancellationToken cancellationToken)
        {
